...
module {
  func.func @memory(%arg: !rust.typed.ref<"shared", i32>) -> !rust.typed.rawptr<"const", i32> {
    ...
    %ref = rust.typed.borrow %slot {borrow_kind = "Shared", mutability = "shared"} : <i32> -> !rust.typed.ref<"shared", i32>
    ...
    %raw = rust.typed.address_of %slot {mutability = "const", raw_ptr_kind = "Const"} : <i32> -> !rust.typed.rawptr<"const", i32>
